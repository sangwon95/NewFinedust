...
//    companion object {
//        const val TAG: String = "MainViewModelFactory - 로그"
//    }
//
...
//        return if (modelClass.isAssignableFrom(HomeActivity::class.java)) {
//            HomeViewModel(this.repository) as T  // MainViewModel의 파라미터 값 반환
//        } else {
